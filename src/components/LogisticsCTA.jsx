    ...
    >
      <div className="max-w-3xl px-4">
        ...
        <motion.div variants={slideIn} initial="hidden" whileInView="visible" viewport={{ once: true }}>
          <button onClick={scrollToContact} className="mt-28 md:mt-10 px-8 py-4 bg-[#FAFAFB] text-[#004EBE] rounded-md text-[18px] md:text-[25px] font-[500] source-sans-3 hover:bg-gray-200">
