    ...
    >
      ...
      <div className="relative z-20 container mx-auto px-6 py-16 pt-32">
        <div className="max-w-4xl">
          ...
          >
            <button onClick={scrollToContact} className="source-sans-3 font-[600] text-[20px] bg-[#004EBE] hover:bg-blue-700 text-white px-[50px] md:px-14 py-4 md:py-5 rounded-md transition-colors">
              Get a Quote
            </button>
