      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4 col-span-2 md:col-span-1">
            <h3 className="text-[24px] text-[600] source-sans-3 mb-4">Contact Information</h3>
            <ul className="text-[16px] text-[500] source-sans-3 space-y-2">
              <li>+1 (435) 264 4145</li>
              <li>info@kadispatchbusiness.com</li>
            </ul>
          </div>
          ...
          <div className="space-y-4 col-span-2 md:col-span-1">
            ...
            <div className="flex justify-center md:justify-start space-x-4">
              <a href="https://x.com/kadispatch_inc" 
                target="_blank" 
              ...
              <a href="https://www.linkedin.com/company/kadispatch" 
                target="_blank" 
                rel="noopener noreferrer" 
                className="hover:text-blue-400 transition-transform hover:scale-110"
              >
              ...
              <a href="https://www.facebook.com/kadispatch" 
                target="_blank" 
                rel="noopener noreferrer" 
                className="hover:text-blue-400 transition-transform hover:scale-110"
              >
              ...
              <a href="https://www.instagram.com/kadispatch" 
                target="_blank" 
                rel="noopener noreferrer" 
                className="hover:text-blue-400 transition-transform hover:scale-110"
              >
